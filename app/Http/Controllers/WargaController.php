...
class WargaController extends Controller
{
    ...
    public function createWarga(Request $request) {
        try {
            ...
            $newKartuKeluarga->domisili = $request->domisili_kartu_keluarga;
    ...
    public function updateDomisiliKartuKeluarga(Request $request, $id_kk) {
        try {
            $kartuKeluargaSekarang = KartuKeluarga::find($id_kk);
            if (empty($kartuKeluargaSekarang)) return response()->json([
                'status' => 400,
            ...
            $kartuKeluargaSekarang->domisili = $request->domisili;
            if ($kartuKeluargaSekarang->save()) return response()->json([
                'status' => 200,
                'message' => 'Domisili Kartu Keluarga berhasil diubah'
            ], 200);

            return response()->json([
                'status' => 400,
                'message' => 'Domisili Tempat Tinggal Kartu Keluarga gagal diubah'
            ], 400);
        } catch (\Exception $e) {
            return response()->json([
                'status' => 500,
    ...
    public function updateAnggotaKeluarga(Request $request, $id_kk, $nik) {
        try {
            ...
            $warga->domisili = $request->domisili;
